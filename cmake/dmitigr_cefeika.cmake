...
set(dmitigr_cefeika_concur_deps assert testo)
set(dmitigr_cefeika_dt_deps assert testo)
set(dmitigr_cefeika_base_deps)
set(dmitigr_cefeika_fcgi_deps assert filesystem math net testo)
set(dmitigr_cefeika_filesystem_deps)
set(dmitigr_cefeika_fsmisc_deps filesystem)
set(dmitigr_cefeika_http_deps assert dt net str testo)
set(dmitigr_cefeika_jrpc_deps assert math rajson str testo)
set(dmitigr_cefeika_math_deps assert testo)
set(dmitigr_cefeika_mem_deps)
set(dmitigr_cefeika_mulf_deps assert str testo)
set(dmitigr_cefeika_net_deps assert base filesystem os testo)
set(dmitigr_cefeika_os_deps assert filesystem progpar testo)
set(dmitigr_cefeika_pgfe_deps assert base filesystem mem net os reader str testo)
set(dmitigr_cefeika_progpar_deps assert filesystem testo)
set(dmitigr_cefeika_rajson_deps thirdparty_rapidjson testo)
...
set(dmitigr_cefeika_ttpl_deps assert testo)
set(dmitigr_cefeika_url_deps assert str testo)
set(dmitigr_cefeika_uuid_deps assert rng testo)
set(dmitigr_cefeika_web_deps assert fcgi filesystem http jrpc mulf reader str ttpl)
set(dmitigr_cefeika_ws_deps assert filesystem net rng testo thirdparty_usockets thirdparty_uwebsockets)
set(dmitigr_cefeika_wscl_deps assert testo thirdparty_uwsc)
